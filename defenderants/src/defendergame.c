...
void attackerAnt(chanend toVisualiser, chanend toController) {
  ...
  ////////////////////////////////////////////////////////////
      ...
      // Switch direction if move forbidden
      if (moveForbidden) {
  ...
  /////////////////////////////////////////////////////////////
      attackerAntPosition = ((attackerAntPosition + 23) + currentDirection) % 23;
  ...
  while (!gameEnded) {
    select {
      case fromAttacker :> attempt:
          // TODO MAKE ANTS NOT PHASE THROUGH UPON DIRECT CONTACT
          // TODO GRACEFUIL SHUTDOWN

          // !!! place your code here to give permission/deny attacker move or to end game

          // if in bottom half of desert
          ...
          if (lastReportedAttackerAntPosition <= 14 && lastReportedAttackerAntPosition >= 8) {
              gameEnded = 1;
          }
        break;
